...
let PostResolver = class PostResolver {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (updoot && updoot.value !== realValue) {
                yield typeorm_1.getConnection().transaction((tm) => __awaiter(this, void 0, void 0, function* () {
                    yield tm.query(`update updoot set value = $1 where "postId" = $2 and "userId" = $3`, [realValue, postId, userId]);
    ...
    createPost(title, body, { req }) {
        return Post_1.Post.create({ title, body, creatorId: req.session.userId }).save();
    }
    updatePost(id, title, body, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
